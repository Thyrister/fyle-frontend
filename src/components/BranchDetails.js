...
const searchAPICall =
  "https://thyristerfyle.herokuapp.com/api/branches?q="
const cityAPICall =
  "https://thyristerfyle.herokuapp.com/api/branches/autocomplete?q=";
...
const BranchDetails = () => {
  ...
  const api = axios.create({
    ...
    const url = "";
  const [currentCity, setCity] = useState("Nashik");
  ...
  return (
    <div align="center" className="container">
        ...
        <div>
          <Form>
            <FormGroup style={{ display: "flex" }}>
              <Label for="citySelection"></Label> {" "}
              <Input
                style={{ width: "10%" ,border :"2px solid grey" }}
                type="select"
                name="citySelection"
                id="citySelection"
                onChange={(e) => {
              ...
              <DebounceInput
                style={{ width: "40%" ,border :"2px solid grey"  }}
      ...
      <div>
        <div >
          {tableData ? (
            <Table bordered responsive dark striped >
              <thead>
                <tr>
                  <th>ID</th>
                  <th>NAME</th>
                ...
                {tableData.map((branch, index) => {
                  return (
                    <tr>
                      ...
                      <td>
                        <Button 
                           style={{width : "100px",background : "#7CFC00", border: "2px solid black", borderRadius  : "20px" ,color:"black"}}
                          onClick={() => {
        ...
        <div>
          ...
          <Form>
            <FormGroup style={{ display: "flex", alignItems: "center" }}>
              ...
              >
                <Input
                  style={{color : "white",background: "black",  border: "2px solid grey" }}
